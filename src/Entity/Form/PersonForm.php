...
/**
 * @file
 * Contains Drupal\chajchu\Entity\Form\PersonForm.
 */
...
class PersonForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status) {
      drupal_set_message($this->t('Saved the %label Person.', array(
        '%label' => $entity->label(),
      )));
    }
    else {
      drupal_set_message($this->t('The %label Person was not saved.', array(
        '%label' => $entity->label(),
      )));
    }
